...
const ESPECIE_OPTIONS: FilterOption[] = Object.keys({ 1: 'Perro', 2: 'Gato', 3: 'Otro' }).map(id => ({
    id: Number(id),
    nombre: obtenerNombreEspecie(Number(id)),
}));

const ESTADOS_SALUD_OPTIONS: FilterOption[] = Object.keys({ 1: 'Saludable', 2: 'Herido', 3: 'Grave' }).map(id => ({
    id: Number(id),
...
const MapsFilterModal: React.FC<MapsFilterModalProps> = ({ 
    ...
    const [selectedEspecie, setSelectedEspecie] = useState<number | string>(currentFilters.especieId || '');
    const [selectedEstadoSalud, setSelectedEstadoSalud] = useState<number | string>(currentFilters.estadoSaludId || '');
    const [selectedZona, setSelectedZona] = useState<string>(currentFilters.zona || '');
    ...
    const handleApply = () => {
        onApplyFilter({
            ...
            estadoSaludId: selectedEstadoSalud === '' ? undefined : selectedEstadoSalud,
        ...
        <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
                <View style={styles.header}>
                    <Text style={styles.headerTitle}>Filtrar Avistamientos</Text>
                    <TouchableOpacity onPress={onClose}>
                        <Ionicons name="close-circle-outline" size={30} color={Colors.darkGray} />
                    </TouchableOpacity>
                </View>
                ...
                <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                    ...
                    <Text style={styles.inputLabel}>Zona/Región:</Text>
                    <View style={styles.pickerWrapper}>
                        <Picker
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity 
                        ...
                        onPress={handleApply}
                    >
                        <Text style={[styles.buttonText, { color: Colors.lightText }]}>Aplicar Filtros</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
